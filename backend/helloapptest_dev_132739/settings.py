"""
Django settings for helloapptest_dev_132739 project.
...
ROOT_URLCONF = 'helloapptest_dev_132739.urls'
...
WSGI_APPLICATION = 'helloapptest_dev_132739.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "helloapptest_dev_132739 API",
    "DESCRIPTION": "API documentation for helloapptest_dev_132739 App",
    "VERSION": "v1",
}
